                  	...
                  	<header>
                        ...
                        <div class="toolbar">
                            <nav style="padding: 5px;">
                                <a data-toggle="modal" id="btn_desc_rep_general" class="btn btn-danger btn-sm" href="{{ URL::to('ventas/dist/reportes/general') }}">
...
@section('resources')
{{ HTML::script('assets/own/js/ventas/dist/reportes/index.js') }}
<script>
$(function(){
    Metis.formGeneral();
});
