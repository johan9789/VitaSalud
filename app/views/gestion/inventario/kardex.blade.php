...
<table id="tabladatoskardex">
    ...
    <tr>
        <td>Cod. Barras: <input type="text" class="form-control codigo" required="" id="codigo" data-id="1"></td>
        <td>Cod. Producto: <input type="text" class="form-control codigobarras" required="" id="codbarras" data-id="1"></td>
        {{ Form::close() }}
        <td colspan="2">
