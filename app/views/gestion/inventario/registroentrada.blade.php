                          ...
                          <div style="float: right;">
                            <nav style="padding: 5px;">
                              @if(Session::has('mensaje_entradas'))    
                                <div id="mensaje_entradas" style="padding: 3px 3px 3px 3px; background: #5cb85c; border-radius:6px; color: #FFF;">&nbsp;&nbsp;{{Session::get('mensaje_entradas')}} ¿Ver Inventario? <a data-placement="bottom" data-original-title="Ir a Inventario" data-toggle="tooltip" class="btn btn-default btn-sm" href="{{URL::to('gestion/inventario')}}"><span class="label label-danger">Si</span></a>&nbsp;&nbsp;
                                </div>
                              @endif
                            </nav>
                          </div>
                            ...
                            <table id="dataTable" class="table table-bordered responsive-table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td colspan="5" style="text-align:right;">{{ Form::submit('Registrar', ['class' => 'btn btn-primary', 'id' => 'btn_registrar_entradas']) }}</td>
                                </tr>
