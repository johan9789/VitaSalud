                ...
                <tr>
                  ...
                  <td>
                      <span class="editar" data-id="N">
                          <a data-toggle="modal" data-original-title="Help" data-placement="bottom" class="btn btn-primary btn-sm" href="#editar_clienteN" data-id="{{$cn->idPersona}}">                   
        ...
        <div id="collapse4" class="body">
          <table id="dataTableClientesJ" class="table table-bordered table-condensed table-hover table-striped">
            ...
            <tbody id="inventario">
                ...
                <tr>
                  <td>{{$i++}}</td>
                  <td>{{$cj->NombreEmpresa}}</td>
                  <td>{{$cj->RUC}}</td>
                  <td>{{$cj->TelefonoEmpresa}}</td>
                  <td>{{$cj->EmailEmpresa}}</td>
                  <td>{{$cj->DireccionEmpresa}}</td>
                  <td>
                      <span class="editar" data-id="J">
                          <a data-toggle="modal" data-original-title="Help" data-placement="bottom" class="btn btn-primary btn-sm" href="#editar_clienteJ" data-id="{{$cj->idEmpresa}}">                   
                              <li class="fa fa-pencil"></li>
                          </a>
                      </span>
                  </td>
