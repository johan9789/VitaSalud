                            ...
                            <div id="dv_rep_compras_act">
                                <table id="data_table_compras" class="table table-bordered table-condensed table-hover table-striped">
                                    ...
                                    <tbody id="">
                                        ...
                                        <tr>
                                            <td>{{{ Date::format($rep->FechaCompra, 'd/m/Y') }}}</td>
                                            <td>{{{ $rep->Factura }}}</td>
                                            <td>S./ {{{ $rep->SubTotalCompra }}}</td>
                                            <td>S./ {{{ $rep->IGVCompra }}}</td>
                                            <td>S./ {{{ $rep->TotalCompra }}}</td>
                                            <td>{{{ $rep->proveedor->razon_social_proveedor }}}</td>
                                            <td>
                                                <a class="btn btn-default btn-sm" onclick="detalle_compra('{{{ $rep->idCompra }}}');" data-toggle="modal" href="#detalle_compra">
...
@section('resources')
{{ HTML::script('assets/own/js/compras/adm/reportes.js') }}
@stop