            ...
            <header>
                ...
                <div style="float: right;">
                    <nav style="padding: 5px;">
                        ...
                        <a class="btn btn-default btn-sm" href="{{ URL::to('distribuidor/productos') }}" data-toggle="modal" target="_blank">
                            <li class="fa fa-check-square-o"></li>
                            Nuevo producto
                        </a>
                    </nav>
            ...
            <div id="div_compras">
                <div id="div_compras_act">                 
                    <div id="collapse4" class="body">
                        {{ Form::open(['url' => 'compras/dist', 'class' => 'form-horizontal', 'id' => 'form_compras']) }}
                                        ...
                                        <td width="250px">
                                            <select data-placeholder="Seleccione Producto..." class="form-control select_prod" name="sel_prod_inv[]" id="select_prod_1" data="1">
                                                <option value="0"></option>
                                                    ...
                                                    <optgroup label="{{{ $cat->NombreCategoriaProductoDist }}}">
                                                        @foreach($productos($cat->idCategoriaProductoDist) as $prod)
                                                        <option value="{{{ $prod->idProductoDist }}}">
                                                            {{{ $prod->NombreProductoDist }}}
                                                        </option>
                                                        @endforeach
                                                    </optgroup>
                                                    @endforeach
                        ...
                        <div id="div-1" class="body">
                            ...
                            <table id="data_table_proveedores" class="table table-bordered table-condensed table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{{ $proveedor->RUC }}}</td>
                                        <td>{{{ $proveedor->razon_social_proveedor_dist }}}</td>
                                        <td>{{{ $proveedor->direccion_proveedor_dist }}}</td>
                                        <td>{{{ $proveedor->distrito->NombreDistrito }}}</td>                             
                                        <td>
                                            <a class="btn btn-default" onclick="seleccionar_proveedor('{{{ $proveedor->id_proveedor_dist }}}');">
                                                <li class="fa fa-check-square-o"></li>
                                            </a>
                                        </td>
                                    </tr>
...
@section('resources')
{{ HTML::script('assets/own/js/compras/dist/index.js') }}
@stop