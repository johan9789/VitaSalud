            ...
            @foreach($trimestres as $index => $trimestre)
                ...
                @if($index == $k)
                    <label class="btn btn-success active">
                        {{HTML::link('distribuidor/inventario/movimientos/'.$index, $trimestre, ['style' => 'color:#FFF; text-decoration:none;'])}}
                    </label>
                @else
            ...
            <div class="col-lg-12">
                <div class="box">
                    <header>
                        ...
                        @if(!$movimientos)<h5>Ningún Movimiento Registrado</h5>@else<h5>Movimientos Realizados</h5>@endif
                    </header>
                    <div id="mensaje"></div>
                            ...
                            <tbody id="movimientos">
                                @foreach($movimientos as $index => $m)
                                    <tr>
                                        ...
                                        <td>{{ $m->producto->NombreProductoDist }}</td>
